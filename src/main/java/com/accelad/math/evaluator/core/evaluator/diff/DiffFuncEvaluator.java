...
import com.accelad.math.evaluator.core.evaluator.OutsideFunction;
import com.accelad.math.evaluator.core.evaluator.Point;
import com.accelad.math.evaluator.core.evaluator.TableFunction;
...
public class DiffFuncEvaluator<X extends Field<X>>
    ...
    protected DifferentialFunction<X> evaluate(Function function,
        ...
        return FunctionKind.fromFunction(function)
    ...
    protected DifferentialFunction<X> evaluate(Operator operator,
        ...
        return OperatorKind.fromOperator(operator)
